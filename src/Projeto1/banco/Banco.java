...
import banco.servico.Relatorio;
import banco.utils.MostraListas;
...
public class Banco {
    ...
    static {
        agencias.add(new Agencia("001", "Florianópolis"));
        agencias.add(new Agencia("002", "São José"));
        contas.add(new ContaCorrente("Joao Pedro", "238472837284", 1500));
        contas.add(new ContaInvestimento("Maria José", "12312412", 1200));
        contas.add(new ContaCorrente("Antonio Souza", "6435453234", 4200));
        contas.add(new ContaPoupanca("Ana Maria da Silva", "5634563456234", 2400));
        contas.add(new ContaCorrente("Marcos Silva", "238472837284", 1300));
        contas.add(new ContaCorrente("Joana Soares", "12312412", 1800));
        contas.add(new ContaPoupanca("Juarez Cardoso", "6435453234", 3500));
        contas.add(new ContaInvestimento("Maria Antonia dos Santos", "5634563456234", 2900));
    }
    ...
    public static void programa() throws InterruptedException, ParseException {
    ...
    public static void criaConta() throws ParseException {
        Scanner sc = new Scanner(System.in);
